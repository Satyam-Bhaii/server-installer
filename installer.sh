#!/usr/bin/env bash
# ============================================================================
#  MEGA SERVER INSTALLER  —  all-in-one server setup tool
#
#  Includes:
...
echo
echo -e "${CYAN}${BOLD}  ╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}${BOLD}  ║           MEGA SERVER INSTALLER  —  all-in-one setup         ║${NC}"
echo -e "${CYAN}${BOLD}  ║   34 tools | Panels | Docker apps | Media | Game servers     ║${NC}"
echo -e "${CYAN}${BOLD}  ╚══════════════════════════════════════════════════════════════╝${NC}"
echo
echo -e "  ${BOLD}Environment:${NC} ${ENV_LABEL} | $(uname -m) | ${DISTRO}"
echo -e "  ${BOLD}systemd:${NC} $([ "$HAS_SYSTEMD" = "1" ] && echo "active" || echo "not active") | ${BOLD}Privileges:${NC} $([ "$IS_ROOT" = "1" ] && echo "root" || echo "user")"
echo
